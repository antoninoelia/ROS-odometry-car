...
(cl:in-package projects_robotics-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <floatStamped>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'floatStamped)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name projects_robotics-msg:<floatStamped> is deprecated: use projects_robotics-msg:floatStamped instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <floatStamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader projects_robotics-msg:header-val is deprecated.  Use projects_robotics-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <floatStamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader projects_robotics-msg:data-val is deprecated.  Use projects_robotics-msg:data instead.")
  (data m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<floatStamped>)))
  ...
  "projects_robotics/floatStamped")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'floatStamped)))
  "Returns string type for a message object of type 'floatStamped"
  "projects_robotics/floatStamped")
